						...
						<div class="card-body">
							...
							<form method="POST" class="my-login-validation" autocomplete="off" action="{{ route('register') }}">
								...
								<div class="form-group">
									...
									<input id="firstname" type="text" class="form-control" name="firstname"  autofocus placeholder="Enter your Firstname" value="{{ old('firstname') }}">
									<span class="text-danger">@error('firstname'){{ $message }}@enderror</span>
								</div>

                                <div class="form-group">
									<label for="lastname">Lastname</label>
									<input id="lastname" type="text" class="form-control" name="lastname"  autofocus placeholder="Enter your lastname" value="{{ old('lastname') }}">
